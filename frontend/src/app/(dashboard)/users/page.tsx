...
export default function UsersPage() {
 ...
 Manage platform users, roles, and invites.
 </p>
 </div>
 ...
 <TableCell className="text-storm/70">{user.email}</TableCell>
 <TableCell>
 ...
 <TableRow>
 <TableCell colSpan={6} className="text-center py-8 text-storm/70">
 No pending invites.
 </TableCell>
 </TableRow>
 )}
