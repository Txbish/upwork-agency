...
export default function MeetingsPage() {
 ...
 Schedule and track client meetings. Drop recordings and notes when they wrap.
 </p>
 </div>
 ...
 <div className="grid gap-4 py-4">
 <div className="grid gap-2">
 <Label htmlFor="detail-meeting-url">Meeting URL</Label>
 <Input
 ...
 <div className="grid grid-cols-3 gap-4">
 <div className="grid gap-2">
 <Label htmlFor="detail-fathom">Fathom URL</Label>
 <Input
 id="detail-fathom"
 value={completeForm.fathomUrl}
 onChange={(e) => setCompleteForm((p) => ({ ...p, fathomUrl: e.target.value }))}
 ...
 <div className="grid gap-2">
 <Label htmlFor="detail-loom">Loom URL</Label>
 <Input
 id="detail-loom"
 value={completeForm.loomUrl}
 onChange={(e) => setCompleteForm((p) => ({ ...p, loomUrl: e.target.value }))}
 ...
 <div className="grid gap-2">
 <Label htmlFor="detail-drive">Drive URL</Label>
 <Input
 id="detail-drive"
 value={completeForm.driveUrl}
 onChange={(e) => setCompleteForm((p) => ({ ...p, driveUrl: e.target.value }))}
 ...
 <span className="text-storm/70">Join</span>
 ) : (
 <a
 ...
 <span className="text-storm/70">---</span>
 )}
 </TableCell>
 <TableCell>
 ...
 <span className="text-storm/70 text-xs">---</span>
 )}
 </div>
 </TableCell>
 <TableCell>
